...
import TitheModal from '../components/TitheModal';
...
export default function UsersPage() {
  ...
  return (
    <main>
      <Title text="Membros" />
      <TitheModal show={showTitheModal} onHide={() => setShowTitheModal(false)}/>
          ...
          {usersViewed.map(user => (
            <Card>
              ...
              <Card.Header>
                ...
                <UserMenu showAccessModal={() => setShowAccessGarantied(true)} showTitheModal={() => setShowTitheModal(true)} showDeleteModal={() => setShowDeleteUserModal(true)} deleteUser={() => handleDelete(user.id)}/>
              </Card.Header>
